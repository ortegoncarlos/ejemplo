...
export declare enum QueueTypes {
...
export declare enum LanguagePoolTypes {
    ENGLISH = "en",
    RUSSIAN = "ru",
}
...
export declare enum RecaptchaWorkerScore {
    LOW = 0.3,
    MEDIUM = 0.5,
    HIGH = 0.9,
}
export declare enum ImageNumericRequirements {
    NO_REQUIREMENTS = 0,
    ONLY_NUMBERS = 1,
    LETTERS_ONLY = 2,
}
